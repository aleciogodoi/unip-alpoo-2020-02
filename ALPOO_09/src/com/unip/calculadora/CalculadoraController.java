...
public class CalculadoraController {
	...
	public CalculadoraController(CalculadoraView view, CalculadoraModel model) {
		...
		// Diz para a classe CalculadoraView, que sempre que botões forem clicados
		// será executado o metodo actionPerformed da classe CalculadoraListener
	...
	class CalculadoraListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			try{
				...
				} else  if (e.getActionCommand() =="Subtração") {
					calculadoraModel.subtrai(numero1, numero2);
				} else  if (e.getActionCommand() =="Multiplicação") {
					calculadoraModel.multiplica(numero1, numero2);
				}  else  if (e.getActionCommand() =="Divisão") {
				...
				calculadoraView.mostraErro("São necessários dois números");
			}	
		}	
	}	
}