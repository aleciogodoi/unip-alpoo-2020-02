...
public class TesteUsuario {
	...
	public static void main(String[] args) {	
		...
		*/
		...
		//usuDAO1.update(new Usuario (103,"Antonio Rodrigues","antonio@gmail.com","(11) 8888-0000","Rua das Acácias, 42"));
		
		// Total de Usuarios
		JOptionPane.showMessageDialog(null,"Total de usuários: "+usuDAO1.selectCount());
