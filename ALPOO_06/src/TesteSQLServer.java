...
public class TesteSQLServer extends Tela implements ActionListener {
	
	private static Connection conn = null; 
	private static Statement stmt;
	static TesteSQLServer x;
	...
	public Connection conectar (){
		try	{
			...
			//String bdUrl = "jdbc:sqlserver://localhost:1433;databaseName=Departamento";
			String bdUrl = "jdbc:sqlserver://LAPTOP-TV548JR1\\MSSQL;DatabaseName=Departamento";
